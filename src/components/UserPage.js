  ...
  return (
    <div className="profile-container">
      ...
      <div>
        ...
        <div className="text-line">{format(user.metadata.creationTime, STANDARD_DATE_FORMAT)}</div>
      </div>
      <div>
        <div className="section-label">Last signed in</div>
        <div className="text-line">{format(user.metadata.lastSignInTime, STANDARD_DATE_FORMAT)}</div>
      </div>
    </div>
  );
}
